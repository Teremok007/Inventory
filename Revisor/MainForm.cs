...
namespace BarcodeFramework
{
    ...
    public class MainForm : System.Windows.Forms.Form
    {
        ...
        const string LoadEANSpr = "LoadEANSpr";
        const string CreateNewDB = "CreateNewDB";
        const string CreateSprEanTable = "CreateSprEanTAble";
        ...
        private ToolBarButton NewOrder;
        private ToolBarButton EditOrder;
        private ToolBarButton DeleteOrder;
        //private MainMenu mainMenu1; // Currently set to 2. So the row height would be doubled in this sample.
                                                 // The user can set it to any value (i.e. 1,2,3,..., etc.) based on the requirements.

        // sprEan - conteins ArtCodes, Names and ean13 of goods
        private SprEan eans;
        ...
        public MainForm()
        {
            ...
            openFileDialog1.Filter = "Справочник ШК (*.spr)|*.spr";
            openFileDialog1.FilterIndex = 2;
            
            this.eans = new SprEan();
        }
        /// <summary>
        ...
        private void InitializeComponent()
        {
          ...
          this.NewOrder = new System.Windows.Forms.ToolBarButton();
          this.EditOrder = new System.Windows.Forms.ToolBarButton();
          this.DeleteOrder = new System.Windows.Forms.ToolBarButton();
          ...
          this.listViewMain.Size = new System.Drawing.Size(318, 238);
          ...
          // toolBar
          // 
          this.toolBar.Buttons.Add(this.NewOrder);
          this.toolBar.Buttons.Add(this.EditOrder);
          this.toolBar.Buttons.Add(this.DeleteOrder);
          ...
          // NewOrder
          // 
          this.NewOrder.ImageIndex = 0;
          this.NewOrder.ToolTipText = "Новый";
          // 
          // EditOrder
          // 
          this.EditOrder.ImageIndex = 2;
          this.EditOrder.ToolTipText = "Редктировать";
          // 
          // DeleteOrder
          // 
          this.DeleteOrder.ImageIndex = 1;
          this.DeleteOrder.ToolTipText = "Удалить";
          // 
          // openFileDialog1
          // 
          this.openFileDialog1.FileName = "sprean.spr";
          // 
          // MainForm
          // 
        ...
        private void MainForm_Load(object sender, System.EventArgs e)
        {
            ...
            //{
            //    this.eans.LoadEanFromFile(openFileDialog1.FileName);
            //}
            ...
            //if (Symbol.Win32.PlatformType.IndexOf("SYMBOL WinCE") != -1)
            //{
        ...
        private void loadMainListViewItems()
        {
            ...
            addListViewItem(i++, CreateSprEanTable);
            addListViewItem(i++, CreateNewDB);
            addListViewItem(i++, LoadEANSpr);
        ...
        private void listViewMain_ItemActivate(object sender, System.EventArgs e)
        {
            ...
            try
            {
              ...
              switch (listViewMain.Items[listViewMain.SelectedIndices[0]].SubItems[nameColumn].Text)
              {
                ...
                case LoadEANSpr:
                  openFileDialog1.InitialDirectory = System.IO.Path.GetDirectoryName(Assembly.GetExecutingAssembly().GetName().CodeBase);
                  if (openFileDialog1.ShowDialog() == DialogResult.OK)
                  {
                    this.eans.LoadEanFromFile(openFileDialog1.FileName);
                  }
                ...
                case CreateNewDB:
                  {
                    ...
                    if (!man.CreateDB(null, out Error))
                      MessageBox.Show(Error,
                          "Create database", MessageBoxButtons.OK, MessageBoxIcon.Exclamation,
        ...
        {
            // If it is CE
            if (Symbol.Win32.PlatformType.IndexOf("SYMBOL WinCE", 0) <= 0)
            {
